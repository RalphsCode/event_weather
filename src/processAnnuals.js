 ...
 * The daily summary was generated by processADay, called by GetWxData.
...
function processAnnuals(weatherResults) {
    ...
    weatherResults.forEach(el => {
        ...
        if (TMAXarr.length > 0) {
            ...
            expectedTMAX = (Math.max(...TMAXarr)).toFixed(0) || null;
            ...
            expectedTMAX = Math.max(...TAVGarr).toFixed(0) || null;
        ...
        if (TMINarr.length > 0) {
            ...
            expectedTMIN = (Math.min(...TMINarr)).toFixed(0) || null;
            ...
            expectedTMIN = Math.min(...TAVGarr).toFixed(0) || null;
